...
namespace ShuHai.Unity
{
    ...
    public static class Colors
    {
        ...
        {
            return new Color(ToFloat(r), ToFloat(g), ToFloat(b), ToFloat(a));
        }

        public static Color32 New32(float r, float g, float b, float a = 1.0f)
        {
        ...
        public static Color AlphaBlend(Color src, Color dst)
        {
            ...
            for (var i = 0; i < 3; ++i) // 0,1,2 => r,g,b
                c[i] = src[i] * src.a + dst[i] * invSrcA;
            //c[i] = src[i] * src.a + dst[i] * dst.a * invSrcA;
            return c;
        }

        //public static Color Blend(Color src, Color dst, float factor) { }

        public static byte ToByte(float channelValue) { return (byte)(channelValue * byte.MaxValue); }

        public static float ToFloat(byte channelValue) { return channelValue / (float)byte.MaxValue; }

        public static Color ToColor(this Color32 color)
        {
            return new Color(ToFloat(color.r), ToFloat(color.g), ToFloat(color.b), ToFloat(color.a));
        }
