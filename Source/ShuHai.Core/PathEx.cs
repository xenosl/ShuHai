...
namespace ShuHai
{
    public enum DirectorySeparatorStyle
    {
        Slash,
        Backslash
    }
    ...
    public static class PathEx
    {
        ...
        public static DirectorySeparatorStyle DirectorySeparatorStyle
        {
            get => _directorySeparatorStyle;
            set
            {
                if (value == _directorySeparatorStyle)
                    return;

                _directorySeparatorStyle = value;

                switch (_directorySeparatorStyle)
                {
                    case DirectorySeparatorStyle.Slash:
                        DirectorySeparator = '/';
                        AltDirectorySeparator = '\\';
                        break;
                    case DirectorySeparatorStyle.Backslash:
                        DirectorySeparator = '\\';
                        AltDirectorySeparator = '/';
                        break;
                    default:
        ...
        public static char DirectorySeparator { get; private set; } = Path.DirectorySeparatorChar;
        public static char AltDirectorySeparator { get; private set; } = Path.AltDirectorySeparatorChar;

        /// <summary>
        ///     Convert specified slash character to its opposite slash character.
        /// </summary>
        public static char AltSeparatorOf(char slash)
        {
            switch (slash)
            {
                case '\\':
        ...
        private static DirectorySeparatorStyle _directorySeparatorStyle =
            IsSlash(DirectorySeparator) ? DirectorySeparatorStyle.Slash : DirectorySeparatorStyle.Backslash;

        private static bool IsSlash(char c) { return c == '/'; }

        #endregion Directory Separator

        public static string Normalize(string path) { return Normalize(path, DirectorySeparator); }
        ...
        public static string Normalize(string path, char separatorSlash)
        {
            ...
            var altSlash = AltSeparatorOf(separatorSlash);
        ...
        public static string MakeRelative(string fromPath, string toPath)
        {
            ...
            if (toUri.Scheme.Equals("file", StringComparison.InvariantCultureIgnoreCase))
                relativePath = relativePath.Replace(AltDirectorySeparator, DirectorySeparator);
        ...
        private static readonly char[] _separators = { DirectorySeparator, AltDirectorySeparator };
    }
}
