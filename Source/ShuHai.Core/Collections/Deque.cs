...
namespace ShuHai.Collections
{
    ...
    [DebuggerDisplay("Count = {Count}, Capacity = {Capacity}"), DebuggerTypeProxy(typeof(Deque<>.DebugView))]
    public sealed class Deque<T> : IList<T>, IList, IReadOnlyList<T>
    {
        /// <summary>
        ...
        private int DequeIndexToBufferIndex(int index) { return (index + _offset) % Capacity; }
        ...
        private T DoGetItem(int index) { return _buffer[DequeIndexToBufferIndex(index)]; }
        ...
        private void DoAddLast(T value)
        {
        ...
        /// </summary>
        /// <param name="value">The element to insert.</param>
        private void DoAddFirst(T value)
        {
